    ...
    [
        new BotDefinition(
            ...
            Requirements(
                ...
                Automated("Configura Drivatar Imbatível e a predefinição Assistência Total"),
        ...
        new BotDefinition(
            ...
            Requirements(
                ...
                Automated("Configura Drivatar Imbatível e a predefinição Extremo, sem assistências"),
        ...
        new BotDefinition(
            ...
            Requirements(
                ...
                Automated("Cada reabastecimento aplica a dificuldade e as assistências exigidas pelo farm chamado"),
        ...
        new BotDefinition(
            ...
            "Farm de Spin · Revuelto",
            "Compra o Revuelto, percorre a rota de 39 SP e prepara o próximo ciclo.",
            "39 SP e 365.000 CR",
            Requirements(
                Automated("SP: ao faltar para outro ciclo, o BOT farma até 999 e relê o saldo"),
                Automated("CR: ao faltar para outro ciclo, o BOT farma até 10.000.000 e relê o saldo"),
                Automated("Subaru 22B e Nissan S-Cargo S1 800 são selecionados nos reabastecimentos"),
                Automated("Cada reabastecimento aplica a dificuldade e as assistências exigidas pelo farm chamado"),
                Required("Aceitar que uma cópia compatível do Lamborghini Revuelto será removida ao fim de cada ciclo")),
            "Na rua, no menu de pausa ou na garagem; o BOT normaliza a entrada.",
            SupportsBackground: true,
            RequiresViGEm: true,
            Experimental: false),
